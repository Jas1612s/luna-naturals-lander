...
const navLinks = ["Shop All", "About Us", "Get in Touch"];
const careLinks = [
  "Search",
  "My Account",
  "Contact",
...
export function EveryMoodFooter() {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="max-md:grid-cols-1 em-footer-grid"
      >
        {/* Column 1 — Subscribe */}
        <div>
          <h3
      ...
      >
        ...
        >
          &copy; 2026 &middot; Everymood&reg;
        </p>
