          ...
          <div className="max-w-[720px] mx-auto relative">
            ...
            <div className="relative pt-10 md:pt-12">
              ...
              <div className="rounded-xl overflow-hidden mb-6">
                <Image src="/images/gruns/kids-lifestyle-stickers.webp" alt="Child placing a mosquito repellent patch sticker on their sleeve" width={720} height={480} className="w-full h-auto object-cover" />
              </div>
        ...
        <section className="bg-[#1a1a2e] py-14 md:py-20 px-4 md:px-6">
          <div className="max-w-[720px] mx-auto">
            ...
            <div className="text-center">
              <a href="/gruns/kids" className="inline-block bg-white text-[#1a1a2e] text-base font-bold rounded-lg px-8 py-4 hover:bg-neutral-100 transition cursor-pointer">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-neutral-200">
              <div className="grid grid-cols-1 sm:grid-cols-2">
                ...
                <div className="p-6 flex flex-col justify-center">
                  ...
                  <a href="/gruns/kids" className="block w-full py-3.5 bg-[#1a1a2e] text-white text-center text-sm font-bold rounded-lg hover:bg-[#2a2a4e] transition cursor-pointer mb-4">
        ...
        <section className="border-t border-neutral-100 px-4 md:px-6 py-10">
          <div className="max-w-[720px] mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {[
                { title: "10 Chemical-Free Products Every Parent Should Know", tag: "Product Roundup" },
                { title: "Mosquito Season 2026: What Experts Are Predicting", tag: "Health" },
                { title: "The Best Outdoor Gear for Kids Under 5", tag: "Parenting" },
              ].map((article) => (
