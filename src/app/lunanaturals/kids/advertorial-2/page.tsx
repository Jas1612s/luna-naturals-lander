            ...
            <figure>
              <div className="relative w-full aspect-[16/9] rounded-xl overflow-hidden">
                <Image
                  ...
                  alt="Mother applying a plant-based repellent sticker to her daughter in a park"
                  fill
        ...
        <article className="max-w-[720px] mx-auto px-4 md:px-6 py-10 md:py-14">
          ...
          <div className="my-10 relative w-full aspect-[4/3] rounded-xl overflow-hidden">
            <Image
              ...
              alt="Child peeling a dinosaur sticker patch and placing it on their yellow t-shirt"
              fill
              className="object-cover"
