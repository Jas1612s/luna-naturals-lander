        ...
        <section className="px-4 md:px-6 pb-2">
          <div className="max-w-[960px] mx-auto">
            <div className="relative aspect-[16/9] md:aspect-[2.2/1] overflow-hidden rounded-xl">
              <Image
                src="/images/gruns/hero-mom-park-v2.png"
                alt="Mother applying a repellent sticker patch to her daughter's sleeve in a sunny park"
                fill
        ...
        <article className="px-4 md:px-6 py-10 md:py-14">
          <div className="max-w-[720px] mx-auto">
            ...
            <div className="relative aspect-[4/3] rounded-xl overflow-hidden mb-2">
              <Image
                src="/images/gruns/kids-placing-sticker-v2.png"
                alt="Child peeling a cute dinosaur sticker patch and placing it on their yellow t-shirt"
                fill
                className="object-cover"
              />
            </div>
        ...
        <section className="border-t border-neutral-100 px-4 md:px-6 py-10">
          <div className="max-w-[720px] mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {[
                { title: "The Rise of Plant-Based Bug Protection", tag: "Wellness", img: "/images/gruns/article-thumb-plant-v2.png" },
                { title: "What Pediatricians Say About DEET in 2026", tag: "Health", img: "/images/gruns/article-thumb-pediatrician-v2.png" },
                { title: "Summer Safety Checklist for Families", tag: "Parenting", img: "/images/gruns/article-thumb-summer-safety-v2.png" },
              ].map((article) => (
